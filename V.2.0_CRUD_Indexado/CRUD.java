...
public class CRUD<T extends Registro>
{
    ...
    public CRUD(Constructor<T> construtor, String fileName) throws Exception
    {
        ...
        indiceDir = new HashExtensivel(10, "dados/livros.diretorio.idx", "dados/livros.cesto.idx"); 
        indiceInd = new ArvoreBMais_String_Int(5, "dados/livros.arvore.idx");
    }
